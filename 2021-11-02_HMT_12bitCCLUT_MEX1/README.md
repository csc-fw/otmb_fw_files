...
The firmware date is 2021-11-02 and the type is TypeA for non-ME11 OTMB.  This version is rolling back to 12bits comparator code. The main change is to add number of layer with hits requirement to HMT. 
