...
The firmware date is 2022-03-29. TypeC and type D OTMB firmware are uploaded here.   Type C for ME11 OTMB in plus endcap and type D for minus endcap.  
...
The main change is fixing the cathode HMT logic and updating the GEMCSC LUTs with improved fitting. 
