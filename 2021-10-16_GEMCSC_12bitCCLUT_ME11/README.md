...
The firmware date is 2021-10-16. Both typeC and typeD OTMB firmware are uploaded here.   Type C for ME11 OTMB in plus endcap and type D for minus endcap.  This version is rolling back to 12bits comparator code. The even-odd chamber parity is extracted from the chamber label
