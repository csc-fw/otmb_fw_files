...
The firmware date is 2022-04-13 and the type is TypeA for non-ME11 OTMB.  

The counters to moinitor CSC fiber sync err are added, which is used for New OTMB phase scan tool.
